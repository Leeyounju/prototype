...
<link rel="stylesheet" href="/resources/css/Manager/Document.css">
	...
	<div id="content">
		...
		<div id="documentSide">
			...
			<div id="rightSide">
				...
				<div id="" class="approvalInfo apv">
					<div class="apvSide " >참조자</div>
				</div>
				<div id="signSide">
					<div id="signHere"> <!-- 사인 들어가는 위치 -->
					</div>
					
					
					<div id ="signBtn"> <!-- 저장버튼 -->
						<input type="button" class="btnStyle" value="저장" onclick="">
						<input type="button" class="btnStyle" value="지우기" onclick="">
					</div>
